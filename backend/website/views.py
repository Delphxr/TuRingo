...
@views.route('/save_webpage', methods=['POST'])
def save_webpage():
    captured_webpage = request.form['captured_webpage']
    ...
    with tempfile.NamedTemporaryFile(suffix='.html', delete=False) as temp_file:
        ...
        print(file_path)
        session['saved_page_path'] = file_path
        session['temp_id_tarea'] = id_tarea

    return 'Progreso guardado'

@views.route('/load_webpage', methods=['GET'])
def load_webpage():
